...
def move_Compare_Main(chara_Move, characterMoves_json, is_case_sensitive, chara_Name):
    ...
    if not move:
        ...
        moveDict = {
            ...
            "Active": move[0]['Active'],
            "Recovery": move[0]['Recovery'],
            "Frame Advantage": move[0]['Frame Advantage'],
            "Notes": move[0]['Notes']
        }
...
def move_Attr_Dict_Creator(moveAttribute_Cells, chara_Name):
    ...
    move_Attribute_Dict['char_guard'] = moveAttribute_Cells['Guard']
    ...
    move_Attribute_Dict['char_active'] = moveAttribute_Cells['Active']
    move_Attribute_Dict['char_recovery'] = moveAttribute_Cells['Recovery']
    move_Attribute_Dict['char_advantage'] = moveAttribute_Cells['Frame Advantage']
