...
description = 'A Dragon Ball Fighter Z Frame Data Bot made by redeem4.'
...
handler = logging.FileHandler(filename='dbzf_bot.log', encoding='utf-8', mode='w')
...
async def on_ready():
    ...
    while True:
        ...
        await asyncio.sleep(30)
        await bot.change_presence(game=discord.Game(name='DragonBallFighterZ'))
        await asyncio.sleep(30)
